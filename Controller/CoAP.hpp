...
static inline size_t HTTPMessageCreate(void* buffer, size_t count, enum HTTPMethod method, const char* host, uint16_t port, const char* path, const void* data, size_t length)
{
